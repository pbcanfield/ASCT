...
class Optimizer():
    ...
    def __init__(self, cell, parameter_range, summary_funct=None, learn_stats=False, sample_dimensionality=128,spike_adaptation_threshold=0.95, spike_height_threshold=0):
        #Set some parameters.
        self.__cell = cell
        ...
        if learn_stats:
            self.embedding_net = SummaryCNN(sample_dimensionality)
    ...
    def simulation_wrapper(self, *args, **kwargs):
        ...
        if not self.__learn_stats:
            ...
            return self.embedding_net.forward(self.__summary_funct())
